                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form method="POST" action="{{ route('register') }}">
                                    ...
                                    <div class="d-flex justify-content-between gap-2">
                                        <button type="submit" class="btn btn-primary w-50" tabindex="4"><i data-feather='user-plus'></i> Daftar</button>
                                        <a href="{{ route('login') }}" class="btn btn-primary w-50 bg-chat-doc" tabindex="4"><i data-feather='log-in'></i> Login</a>
                                    </div>                                    
                                </form>
                            </div>
                        </div>
